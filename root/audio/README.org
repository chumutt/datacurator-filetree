...
The audio section contains any kind of sound that is contained within a file - such as music, sounds, sound effects, podcasts, audiobooks, event recordings (musicals, concerts, standup comedy), games and many others.

Some common file types are:

=*.{raw,wav,flac,mp3,m4a,m4b,ogg,opus,aiff,aac}=
...
#+name: A Regular Album with a Single Disc
#+begin_src
%A - %T (%y) [%f]/%n - %t
#+end_src
#+begin_example
...
#+name: A Regular Album with Multiple Discs
#+begin_src
%A - %T (%y) [%f]/Disc %D/%n - %t
#+end_src
#+begin_example
...
#+name: A Single-Disc Compilation Album
#+begin_src
%A - %T (%y) [%f]/%n - %a - %t
#+end_src
#+begin_example
...
#+name: A Multi-Disc Compilation Album
#+begin_src
